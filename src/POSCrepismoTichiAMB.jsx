...
var INSUMOS_INIT=[
  ...
  {id:"jar_mora",nombre:"Jarabe mora azul",unidad:"ml",minimo:480},
  {id:"jar_fresa",nombre:"Jarabe de fresa",unidad:"ml",minimo:480},
  ...
  {id:"oreo",nombre:"Galleta Oreo",unidad:"g",minimo:600},
  ...
  {id:"tejate",nombre:"Tejate",unidad:"ml",minimo:360},
  {id:"nutella",nombre:"Nutella",unidad:"g",minimo:400},
  ...
  {id:"nuez",nombre:"Nuez",unidad:"g",minimo:200},
  ...
  {id:"jamon",nombre:"Jamon",unidad:"g",minimo:300},
  ...
  {id:"agua_mineral",nombre:"Agua mineral",unidad:"ml",minimo:960},
...
var R={
  "Oreo":[{id:"leche_deslac",c:oz(4)},{id:"oreo",c:oz(2)},{id:"choc_polvo",c:oz(0.3)},{id:"base_neutra",c:oz(1)},{id:"vaso_18oz",c:1},{id:"tapa_domo",c:1},{id:"popote",c:1}],
  "Mango-Taro":[{id:"leche_deslac",c:oz(4)},{id:"jar_mango",c:pp(4)},{id:"mango",c:oz(1)},{id:"base_neutra",c:oz(1)},{id:"crema_lyncott",c:oz(3)},{id:"jar_taro",c:oz(1)},{id:"vaso_18oz",c:1},{id:"tapa_domo",c:1},{id:"popote",c:1}],
  "Chocolate":[{id:"leche_deslac",c:oz(4)},{id:"choc_polvo",c:oz(1.5)},{id:"base_neutra",c:oz(1)},{id:"vaso_18oz",c:1},{id:"tapa_domo",c:1},{id:"popote",c:1}],
  "Capuchino Regular":[{id:"leche_deslac",c:oz(3)},{id:"cafe_grano",c:oz(2)},{id:"base_neutra",c:oz(2)},{id:"vaso_18oz",c:1},{id:"tapa_domo",c:1},{id:"popote",c:1}],
  "Capuchino Cajeta":[{id:"leche_deslac",c:oz(3)},{id:"cafe_grano",c:oz(2)},{id:"base_neutra",c:oz(1)},{id:"jar_caramelo",c:pp(4)},{id:"vaso_18oz",c:1},{id:"tapa_domo",c:1},{id:"popote",c:1}],
  "Capuchino Banana":[{id:"leche_deslac",c:oz(3)},{id:"cafe_grano",c:oz(2)},{id:"base_neutra",c:oz(1)},{id:"jar_banana",c:pp(4)},{id:"vaso_18oz",c:1},{id:"tapa_domo",c:1},{id:"popote",c:1}],
  "Brownie":[{id:"leche_deslac",c:oz(4)},{id:"brownie",c:oz(2.5)},{id:"jar_chocolate",c:pp(2)},{id:"base_neutra",c:oz(1)},{id:"choc_polvo",c:oz(0.5)},{id:"vaso_18oz",c:1},{id:"tapa_domo",c:1},{id:"popote",c:1}],
  "Moca F":[{id:"leche_deslac",c:oz(3)},{id:"cafe_grano",c:oz(2)},{id:"jar_chocolate",c:pp(1)},{id:"base_neutra",c:oz(1.3)},{id:"choc_polvo",c:oz(1)},{id:"vaso_18oz",c:1},{id:"tapa_domo",c:1},{id:"popote",c:1}],
  "Pina Colada":[{id:"leche_deslac",c:oz(4)},{id:"jar_pina",c:oz(1)},{id:"pina",c:oz(1)},{id:"jar_coco",c:pp(4)},{id:"base_neutra",c:oz(1)},{id:"vaso_18oz",c:1},{id:"tapa_domo",c:1},{id:"popote",c:1}],
  ...
  "Capuchino CC":[{id:"cafe_grano",c:oz(1.5)},{id:"leche_deslac",c:oz(9)},{id:"vaso_carton",c:1},{id:"tapa_carton",c:1}],
  "Latte":[{id:"cafe_grano",c:oz(1)},{id:"leche_deslac",c:oz(9)},{id:"vaso_carton",c:1},{id:"tapa_carton",c:1}],
  "Moca CC":[{id:"cafe_grano",c:oz(1.3)},{id:"choc_polvo",c:oz(1)},{id:"leche_deslac",c:oz(9)},{id:"vaso_carton",c:1},{id:"tapa_carton",c:1}],
  "Chocolate CC":[{id:"leche_deslac",c:oz(1.2)},{id:"choc_polvo",c:oz(9)},{id:"cafe_grano",c:oz(2)},{id:"vaso_carton",c:1},{id:"tapa_carton",c:1}],
  "Latte Sin Azucar":[{id:"leche_vegetal",c:oz(8)},{id:"monk_fruit",c:1},{id:"cafe_grano",c:oz(1.5)},{id:"vaso_carton",c:1},{id:"tapa_carton",c:1}],
  "Fresa Platano":[{id:"yogurt",c:oz(3)},{id:"leche_deslac",c:oz(1)},{id:"base_neutra",c:oz(1)},{id:"fresa",c:oz(2)},{id:"platano",c:0.5},{id:"jar_fresa",c:oz(1)},{id:"vaso_18oz",c:1},{id:"tapa_domo",c:1},{id:"popote",c:1}],
  "Mango Durazno":[{id:"yogurt",c:oz(3)},{id:"leche_deslac",c:oz(1)},{id:"base_neutra",c:oz(1)},{id:"mango",c:oz(2)},{id:"durazno_almibar",c:1},{id:"jar_mango",c:oz(1.5)},{id:"vaso_18oz",c:1},{id:"tapa_domo",c:1},{id:"popote",c:1}],
  "Slush Fresa":[{id:"agua_mineral",c:oz(5)},{id:"base_cristal",c:oz(1)},{id:"fresa",c:oz(2)},{id:"jar_fresa",c:pp(5)},{id:"vaso_18oz",c:1},{id:"tapa_domo",c:1},{id:"popote",c:1}],
  "Slush Mango":[{id:"agua_mineral",c:oz(5)},{id:"base_cristal",c:oz(1)},{id:"mango",c:oz(2)},{id:"jar_mango",c:pp(4)},{id:"vaso_18oz",c:1},{id:"tapa_domo",c:1},{id:"popote",c:1}],
  "Slush Pina":[{id:"agua_mineral",c:oz(5)},{id:"base_cristal",c:oz(1)},{id:"pina",c:oz(2)},{id:"jar_pina",c:pp(4)},{id:"vaso_18oz",c:1},{id:"tapa_domo",c:1},{id:"popote",c:1}],
  "Pink Lemonade":[{id:"jar_fresa",c:pp(6)},{id:"perlas_fresa",c:oz(1)},{id:"agua_mineral",c:oz(10)},{id:"vaso_18oz",c:1},{id:"tapa_domo",c:1},{id:"popote",c:1}],
  "Manzana Verde":[{id:"jar_manzana",c:pp(6)},{id:"perlas_manzana",c:oz(1)},{id:"agua_mineral",c:oz(10)},{id:"vaso_18oz",c:1},{id:"tapa_domo",c:1},{id:"popote",c:1}],
...
function POS(props){
  ...
  var _hoyStr=hoy();
  var ventasHoy=ventas.filter(function(v){return v.tienda===tiendaId&&v.timestamp&&v.timestamp.startsWith(_hoyStr)&&v.estadoPago!=="reembolsado";});
  var _hoyStr=hoy();
  var ventasHoy=ventas.filter(function(v){return v.tienda===tiendaId&&v.timestamp&&v.timestamp.startsWith(_hoyStr)&&v.estadoPago!=="reembolsado";});
  ...
  function renderProds(cat){
    ...
    return cat.prods.map(function(prod,i){
      var nombre=typeof prod==="string"?prod:(prod.lbl||prod.n);
      var precio=typeof prod==="object"&&prod.p?prod.p:cat.precio;
      ...
      return re("button",{key:i,onClick:function(){abrirProd(cat,prod);},style:PB},
        re("div",{style:{fontSize:9,fontWeight:800,color:C.dark,textAlign:"center",lineHeight:1.1}},nombre),
        re("div",{style:{fontSize:9,color:C.green,fontWeight:700,marginTop:2}},fmt(precio)),
  ...
  return re("div",{style:{padding:"10px 10px 70px"}},
    ...
    !catActiva&&!verPromos?re("div",null,
      ...
      re("div",{style:{display:"grid",gridTemplateColumns:"repeat(5,1fr)",gap:5,marginBottom:10}},
        MENU.map(function(cat){return re("button",{key:cat.id,onClick:function(){setCat(cat);},style:CB},
          re("div",{style:{fontSize:16}},cat.emoji),
    ...
    catActiva?re("div",null,
      re("button",{onClick:function(){setCat(null);},style:{background:"none",border:"none",color:C.dark,fontWeight:700,fontSize:14,cursor:"pointer",marginBottom:12,padding:0}},"<- Categorias"),
    ...
    verCorte?re("div",{style:{background:C.dark,borderRadius:16,padding:18,color:"#fff"}},
      re("div",{style:{fontSize:13,fontWeight:700,textTransform:"uppercase",letterSpacing:.5,opacity:.6,marginBottom:14}},"Corte del dia"),
...
function Pedidos(props){
  ...
  var s5=useState(false);var modalPinReemb=s5[0];var setModalPinReemb=s5[1];
  var s6=useState(null);var ventaReembolso=s6[0];var setVentaReembolso=s6[1];
  var montoDidiNum=parseFloat(montoDidiInput)||0;

  var hoyStr=hoy();
  var ventasHoy=ventas.filter(function(v){return v.tienda===tiendaId&&v.timestamp&&v.timestamp.startsWith(hoyStr);});
  ...
  function iniciarReembolso(venta){
    setVentaReembolso(venta);
    setSelected(null);
    setModalPinReemb(true);
  }

  function confirmarReembolso(){
    if(onReembolso)onReembolso(ventaReembolso);
    setVentaReembolso(null);
    setModalPinReemb(false);
  }

  if(selected){
    var esDidi=selected.metodo==="didi"&&selected.estadoPago==="por_pagar";
    var esReembolsado=selected.estadoPago==="reembolsado";
    return re("div",{style:OV},re("div",{style:Object.assign({},MD,{maxWidth:380,maxHeight:"90vh",overflowY:"auto"})},
      re("div",{style:{textAlign:"center",marginBottom:14}},
        re("div",{style:{fontSize:20,fontWeight:900,color:C.dark}},
          tiendaId==="centro"?"Crepisimo Centro":tiendaId==="sanantonio"?"Crepisimo San Antonio":tiendaId==="amburger"?"AM-Burger":"Tichi"
        ),
        re("div",{style:{fontSize:12,color:"#aaa",marginTop:4}},fmtFecha(selected.timestamp))
      ),
      esReembolsado?re("div",{style:{background:C.redL,borderRadius:10,padding:"8px 14px",marginBottom:14,textAlign:"center",fontSize:13,color:C.red,fontWeight:700}},"REEMBOLSADO"):null,
      re("div",{style:{borderTop:"2px dashed #e0e0e0",paddingTop:14,marginBottom:14}},
      ...
      re("div",{style:{textAlign:"center",fontSize:11,color:"#aaa",marginBottom:14}},"Gracias por su preferencia"),
      !esReembolsado?re("button",{onClick:function(){iniciarReembolso(selected);},style:{width:"100%",padding:"12px",background:C.redL,color:C.red,border:"2px solid "+C.red,borderRadius:10,fontWeight:800,fontSize:14,cursor:"pointer",marginBottom:8}},"🔄 Hacer reembolso"):null,
  ...
  return re("div",{style:{padding:"10px 10px 70px"}},
    re("div",{style:{fontSize:17,fontWeight:900,color:C.dark,marginBottom:6}},"Pedidos del dia"),
    re("div",{style:{fontSize:13,color:"#888",marginBottom:14}},ventasHoyActivas.length+" pedidos | "+fmt(ventasHoyActivas.reduce(function(s,v){return s+v.total;},0))),
    totalDidiPendiente>0?re("div",{style:{background:"#FFF3E0",border:"2px solid #FF6D00",borderRadius:12,padding:"12px 14px",marginBottom:14}},
      re("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center"}},
        re("div",null,
          re("div",{style:{fontSize:12,fontWeight:800,color:"#E65100"}},"Por cobrar de Didi Food (T. Migue)"),
    ...
    ventasHoy.length===0?re("div",{style:{textAlign:"center",color:"#bbb",padding:40,fontSize:14}},"Sin pedidos hoy"):null,
    ventasHoy.map(function(v,i){
      var items=v.items||[];
      var esDidiP=v.metodo==="didi"&&v.estadoPago==="por_pagar";
      var esReemb=v.estadoPago==="reembolsado";
      return re("div",{key:i,onClick:function(){setSelected(v);},style:{background:"#fff",borderRadius:12,padding:"13px 15px",marginBottom:10,boxShadow:"0 1px 4px rgba(0,0,0,.07)",cursor:"pointer",borderLeft:"4px solid "+(esReemb?C.red:esDidiP?"#FF6D00":C.dark),opacity:esReemb?.6:1}},
        re("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"flex-start"}},
          re("div",null,
            re("div",{style:{fontSize:14,fontWeight:700,color:esReemb?C.red:C.dark}},"Pedido #"+(ventasHoy.length-i)+(esReemb?" (REEMBOLSADO)":"")),
          ...
          re("div",{style:{textAlign:"right"}},
            re("div",{style:{fontSize:18,fontWeight:900,color:esReemb?C.red:C.green}},fmt(v.total)),
            re("div",{style:{fontSize:11,color:C.teal,marginTop:4,fontWeight:600}},"Ver ticket ->")
          )
        )
      );
    }),
    modalPinReemb?re(ModalPinReembolso,{onAcceso:confirmarReembolso,onClose:function(){setModalPinReemb(false);setVentaReembolso(null);}}):null,
    modalDidi?re("div",{style:OV},re("div",{style:Object.assign({},MD,{maxHeight:"90vh",overflowY:"auto"})},
      ...
      diasSelec.length>0?re("div",{style:{background:"#FFF3E0",borderRadius:10,padding:"12px 14px",marginBottom:14,marginTop:8}},
        ...
        montoDidiNum>0?re("div",{style:{marginTop:10}},
          re("div",{style:{display:"flex",justifyContent:"space-between",fontSize:13,marginBottom:4}},re("span",{style:{color:"#555"}},"Ventas (neto esperado)"),re("span",{style:{fontWeight:700}},fmt(totalSelec))),
...
function POSAmburger(props){
  ...
  var hoyStr=hoy();
  var ventasHoy=ventas.filter(function(v){return v.tienda===tiendaId&&v.timestamp&&v.timestamp.startsWith(hoyStr)&&v.estadoPago!=="reembolsado";});
  var gastosCajaHoy=gastos.filter(function(g){return g.tienda===tiendaId&&g.seccion==="caja"&&g.timestamp&&g.timestamp.startsWith(hoyStr);});
  var tv=ventasHoy.reduce(function(s,v){return s+v.total;},0);
  var tEf=ventasHoy.filter(function(v){return v.metodo==="efectivo";}).reduce(function(s,v){return s+v.total;},0);
  var tTr=ventasHoy.filter(function(v){return v.metodo==="transferencia";}).reduce(function(s,v){return s+v.total;},0);
  var tCl=ventasHoy.filter(function(v){return v.metodo==="clip";}).reduce(function(s,v){return s+v.netoRecibido;},0);
...
function PedidosTichi(props){
  ...
  var hoyStr=hoy();
  var ventasHoy=ventas.filter(function(v){return v.tienda===tiendaId&&v.timestamp&&v.timestamp.startsWith(hoyStr);});
  var ventasActivas=ventasHoy.filter(function(v){return v.estadoPago!=="reembolsado";});
  var porPagar=ventasActivas.filter(function(v){return v.estadoPago==="por_pagar";});
  ...
  if(sel){
    ...
    return re("div",{style:OV},re("div",{style:Object.assign({},MD,{maxWidth:380,maxHeight:"90vh",overflowY:"auto"})},
      ...
      re("div",{style:{borderTop:"2px dashed #e0e0e0",paddingTop:14,marginBottom:14}},
        ...
        sel.comisionML>0?re("div",{style:{fontSize:13,color:C.red,marginTop:2}},"Comision ML: -"+fmt(sel.comisionML)):null
      ),
  ...
  return re("div",{style:{padding:"14px 12px 80px"}},
    re("div",{style:{fontSize:17,fontWeight:900,color:TC.dark,marginBottom:6}},"Pedidos del dia"),
    re("div",{style:{fontSize:13,color:"#888",marginBottom:14}},ventasActivas.length+" pedidos | "+fmt(ventasActivas.reduce(function(s,v){return s+v.total;},0))),
    porPagar.length>0?re("div",{style:{background:"#FFF8E1",border:"2px solid #FFC107",borderRadius:12,padding:"10px 14px",marginBottom:14}},
      re("div",{style:{fontSize:12,fontWeight:800,color:"#F57F17"}},"Por cobrar de Mercado Libre (T. Angel): "+fmt(porPagar.reduce(function(s,v){return s+v.total;},0)))
    ):null,
    ventasHoy.length===0?re("div",{style:{textAlign:"center",color:"#bbb",padding:40,fontSize:14}},"Sin pedidos hoy"):null,
    ventasHoy.map(function(v,i){
      var items=v.items||[];
      ...
      return re("div",{key:i,onClick:function(){setSel(v);},style:{background:"#fff",borderRadius:12,padding:"13px 15px",marginBottom:10,boxShadow:"0 1px 4px rgba(0,0,0,.07)",cursor:"pointer",borderLeft:"4px solid "+(esReembV?C.red:esPorPagarV?"#FFC107":TC.dark),opacity:esReembV?.6:1}},
        re("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"flex-start"}},
          re("div",null,
            re("div",{style:{fontSize:14,fontWeight:700,color:esReembV?C.red:TC.dark}},"Pedido #"+(ventasHoy.length-i)+(esReembV?" (REEMBOLSADO)":"")),
            re("div",{style:{fontSize:12,color:"#aaa",marginTop:2}},fmtFecha(v.timestamp)),
            re("div",{style:{fontSize:12,color:"#888",marginTop:4}},items.slice(0,2).map(function(x){return x.nombre;}).join(", ")+(items.length>2?" +"+(items.length-2)+" mas":"")),
...
function FinanzasGlobal(props){
  ...
  function getRango(){
    var hoyD=new Date();
    var hoyStr=hoyD.toISOString().split("T")[0];
  ...
  var rango=getRango();
  function enRango(ts){if(!ts)return false;var d=ts.split("T")[0];return d>=rango.ini&&d<=rango.fin;}
  ...
  if(vista==="finanzas"){
    return re("div",{style:{minHeight:"100vh",background:"#f0f2f7",fontFamily:"'Segoe UI',system-ui,sans-serif"}},
      re("div",{style:{background:C.dark,padding:"14px 14px 0",position:"sticky",top:0,zIndex:100,boxShadow:"0 2px 8px rgba(0,0,0,.2)"}},
        re("button",{onClick:function(){setVista("selector");},style:{background:"none",border:"none",color:"rgba(255,255,255,.7)",fontSize:12,cursor:"pointer",padding:0,marginBottom:4,display:"block"}},"<- Inicio"),
